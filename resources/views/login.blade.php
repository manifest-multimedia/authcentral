                    ...
                    <div class="mb-4 row g-6">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input class="shadow form-control text-secondary-dark" id="email" type="email"
                                    name="email" required autofocus aria-describedby="emailHelp"
                                    placeholder="youremail@pnmtc.edu.gh">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                    ...
                    <div class="mb-6 row align-items-center justify-content-between g-2">
                        <div class="col-auto">
                            <div class="form-check">
                                ...
                                <label class="form-check-label fs-13 fw-medium text-light-dark"
                                    for="remember_me">Remember me</label>
                            </div>
                        </div>
                        <div class="col-auto">
                            <a class="fs-13 fw-medium text-primary link-primary"
