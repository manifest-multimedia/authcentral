            ...
            <div class="card-body">
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $role->name) }}" required {{ in_array($role->name, ['System', 'Super Admin']) && !auth()->user()->hasRole('System') ? 'disabled' : '' }}>
                        @error('name')
                                        ...
                                        <div class="col-md-4 mb-2">
                                            <div class="form-check">
                                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                                    ...
                                                    {{ in_array($role->name, ['System', 'Super Admin']) && !auth()->user()->hasRole('System') ? 'disabled' : '' }}>
