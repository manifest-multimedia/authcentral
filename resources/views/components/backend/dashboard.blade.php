		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="flex-row page d-flex flex-column-fluid">
				...
				<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
					...
					<!--end::Logo-->
					<!--begin::Nav-->
					<div class="pt-0 pb-7 aside-menu flex-column-fluid py-lg-10" id="kt_aside_menu">
						<!--begin::Aside menu-->
						<div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-y scroll-lg-ms d-flex" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: trur}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
							<div id="kt_aside_menu" class="my-auto menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-500 menu-arrow-gray-500 fw-semibold fs-6" data-kt-menu="true">
								<!--begin:Menu item-->
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="py-2 menu-item here show">
									<!--begin:Menu link-->
									...
									<!--end:Menu link-->
									<!--begin:Menu sub-->
									<div class="overflow-auto px-2 py-4 menu-sub menu-sub-dropdown w-250px mh-75">
										<!--begin:Menu item-->
										<div class="menu-item">
											<!--begin:Menu content-->
											<div class="menu-content">
												<span class="py-1 menu-section fs-5 fw-bolder ps-1">Home</span>
											</div>
											<!--end:Menu content-->
										</div>
										<!--end:Menu item-->
										...
										<div class="menu-item">
											<div class="menu-content">
												<a class="p-0 mb-2 btn btn-flex btn-color-primary d-flex flex-stack fs-base ms-2 toggle collapsible collapsed" data-bs-toggle="collapse" href="#kt_app_sidebar_menu_dashboards_collapse" data-kt-toggle-text="Show Less">
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="py-2 menu-item">
									...
									<!--end:Menu link-->
									<!--begin:Menu sub-->
									<div class="overflow-auto px-2 py-4 menu-sub menu-sub-dropdown menu-sub-indention w-250px mh-75">
										<!--begin:Menu item-->
										<div class="menu-item">
											<!--begin:Menu content-->
											<div class="menu-content">
												<span class="py-1 menu-section fs-5 fw-bolder ps-1">Pages</span>
											</div>
											<!--end:Menu content-->
										</div>
										<!--end:Menu item-->
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="py-2 menu-item">
									...
									<div class="overflow-auto px-2 py-4 menu-sub menu-sub-dropdown menu-sub-indention w-250px mh-75">
										...
										<div class="menu-item">
											<!--begin:Menu content-->
											<div class="menu-content">
												<span class="py-1 menu-section fs-5 fw-bolder ps-1">Utilities</span>
											</div>
											<!--end:Menu content-->
										</div>
										<!--end:Menu item-->
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="py-2 menu-item">
									...
									<div class="overflow-auto px-2 py-4 menu-sub menu-sub-dropdown menu-sub-indention w-250px mh-75">
										...
										<div class="menu-item">
											<!--begin:Menu content-->
											<div class="menu-content">
												<span class="py-1 menu-section fs-5 fw-bolder ps-1">Apps</span>
											</div>
											<!--end:Menu content-->
										</div>
										<!--end:Menu item-->
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="py-2 menu-item">
									...
									<!--end:Menu link-->
									<!--begin:Menu sub-->
									<div class="overflow-auto px-2 py-4 menu-sub menu-sub-dropdown w-200px w-lg-225px mh-75">
										<!--begin:Menu item-->
										<div class="menu-item">
											<!--begin:Menu content-->
											<div class="menu-content">
												<span class="py-1 menu-section fs-5 fw-bolder ps-1">Help</span>
											</div>
											<!--end:Menu content-->
										</div>
										<!--end:Menu item-->
							...
							<div class="row g-5 g-xl-8">
								...
								<div class="col-xl-4">
									...
									<div class="mb-5 row mb-xl-8 g-5 g-xl-8">
										...
										<div class="col-6">
											<!--begin::Card-->
											<a class="p-10 text-gray-800 card flex-column justfiy-content-start align-items-start text-start w-100 text-hover-primary" href="apps/customers/view.html">
												<i class="mb-5 text-gray-500 ki-duotone ki-abstract-26 fs-2tx ms-n1">
													<span class="path1"></span>
													<span class="path2"></span>
												</i>
										...
										<div class="col-6">
											<!--begin::Card-->
											<a class="p-10 text-gray-800 card flex-column justfiy-content-start align-items-start text-start w-100 text-hover-primary" href="apps/projects/project.html">
												<i class="mb-5 text-gray-500 ki-duotone ki-basket fs-2tx ms-n1">
													<span class="path1"></span>
													<span class="path2"></span>
													<span class="path3"></span>
													<span class="path4"></span>
										...
										<div class="col-6">
											<!--begin::Card-->
											<a class="p-10 text-gray-800 card flex-column justfiy-content-start align-items-start text-start w-100 text-hover-primary" href="apps/projects/users.html">
									...
									<div class="mb-5 card mb-xl-8">
										...
										<div class="mt-4 border-0 card-header align-items-center">
											...
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_66781916aa879">
													<!--begin::Header-->
													<div class="px-7 py-5">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															...
															<!--begin::Input-->
															<div>
																<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_66781916aa879" data-allow-clear="true">
																	<option></option>
									...
									<div class="card mb-xl-8">
										...
										<div class="pt-5 border-0 card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="text-gray-900 card-label fw-bold">Trends</span>
												<span class="mt-1 text-muted fw-semibold fs-7">Latest tech trends</span>
											</h3>
											<div class="card-toolbar">
												<!--begin::Menu-->
												<button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
										...
										<div class="pt-5 card-body">
											...
											<div class="mb-7 d-flex align-items-sm-center">
												...
												<div class="flex-wrap d-flex align-items-center flex-row-fluid">
													...
													<span class="my-2 badge badge-light fw-bold">+82$</span>
												</div>
												<!--end::Section-->
											</div>
											<!--end::Item-->
											...
											<div class="mb-7 d-flex align-items-sm-center">
												...
												<div class="flex-wrap d-flex align-items-center flex-row-fluid">
													...
													<span class="my-2 badge badge-light fw-bold">+280$</span>
												</div>
												<!--end::Section-->
											</div>
											<!--end::Item-->
											...
											<div class="mb-7 d-flex align-items-sm-center">
												...
												<div class="flex-wrap d-flex align-items-center flex-row-fluid">
													...
													<span class="my-2 badge badge-light fw-bold">+4500$</span>
												</div>
												<!--end::Section-->
											</div>
											<!--end::Item-->
											...
											<div class="mb-7 d-flex align-items-sm-center">
												...
												<div class="flex-wrap d-flex align-items-center flex-row-fluid">
													...
													<span class="my-2 badge badge-light fw-bold">+686$</span>
												</div>
												<!--end::Section-->
											</div>
											<!--end::Item-->
											...
											<div class="mb-7 d-flex align-items-sm-center">
												...
												<div class="flex-wrap d-flex align-items-center flex-row-fluid">
													...
													<span class="my-2 badge badge-light fw-bold">+726$</span>
												</div>
												<!--end::Section-->
											</div>
											<!--end::Item-->
											...
											<div class="d-flex align-items-sm-center">
												...
												<div class="flex-wrap d-flex align-items-center flex-row-fluid">
													...
													<span class="my-2 badge badge-light fw-bold">+145$</span>
												</div>
												<!--end::Section-->
											</div>
											<!--end::Item-->
								...
								<div class="col-xl-8 ps-xl-12">
									...
									<div class="mb-5 border-0 card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-xl-8" style="background-position: 100% 50px;background-size: 500px auto;background-image:url('assets/media/misc/city.png')" dir="ltr">
										<!--begin::Body-->
										<div class="card-body d-flex flex-column justify-content-center ps-lg-12">
											<!--begin::Title-->
											<h3 class="mb-7 text-white fs-2qx fw-bold">We are working 
											<br />to boost lovely mood</h3>
											<!--end::Title-->
											<!--begin::Action-->
											<div class="m-0">
												<a href='#' class="px-6 py-3 btn btn-success fw-semibold" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Create a Store</a>
											</div>
											<!--begin::Action-->
										</div>
										<!--end::Body-->
										...
										<div class="col-xl-6">
											...
											<div class="card card-xl-stretch mb-xl-8">
												...
												<div class="py-5 border-0 card-header">
													<h3 class="card-title align-items-start flex-column">
														<span class="mb-1 card-label fw-bold fs-3">Trends</span>
													...
													<div class="mt-5">
														...
														<div class="mb-5 d-flex flex-stack">
															...
															<div class="d-flex align-items-center me-2">
																...
																<!--begin::Title-->
																<div>
																	<a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">Top Authors</a>
																	<div class="mt-1 fs-7 text-muted fw-semibold">Ricky Hunt, Sandra Trepp</div>
																</div>
																<!--end::Title-->
															</div>
															<!--end::Section-->
															<!--begin::Label-->
															<div class="px-3 py-4 badge badge-light fw-semibold">+82$</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
														<!--begin::Item-->
														<div class="mb-5 d-flex flex-stack">
															...
															<div class="d-flex align-items-center me-2">
																...
																<!--begin::Title-->
																<div>
																	<a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">Top Sales</a>
																	<div class="mt-1 fs-7 text-muted fw-semibold">PitStop Emails</div>
																</div>
																<!--end::Title-->
															</div>
															<!--end::Section-->
														...
														<div class="d-flex flex-stack">
															...
															<div class="d-flex align-items-center me-2">
																...
																<!--begin::Title-->
																<div class="py-1">
																	<a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">Top Engagement</a>
																	<div class="mt-1 fs-7 text-muted fw-semibold">KT.com</div>
																</div>
																<!--end::Title-->
															</div>
															<!--end::Section-->
										...
										<div class="col-xl-6">
											...
											<div class="mb-5 card card-xl-stretch mb-xl-8">
												...
												<div class="border-0 card-header">
													<h3 class="text-gray-900 card-title fw-bold">Todo</h3>
													<div class="card-toolbar">
														<!--begin::Menu-->
														<button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
															<i class="ki-duotone ki-category fs-6">
									...
									<div class="mb-5 card mb-xl-8">
										...
										<div class="pt-5 border-0 card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="mb-1 card-label fw-bold fs-3">Latest Products</span>
												<span class="mt-1 text-muted fw-semibold fs-7">More than 400 new products</span>
											</h3>
											<div class="card-toolbar">
												<ul class="nav">
													<li class="nav-item">
														...
														<table class="table align-middle table-row-dashed table-row-gray-200 gs-0 gy-4">
															...
															<tbody>
																<tr>
																	...
																	<td>
																		<a href="#" class="mb-1 text-gray-900 fw-bold text-hover-primary fs-6">Brad Simmons</a>
																...
																<tr>
																	...
																	<td>
																		<a href="#" class="mb-1 text-gray-900 fw-bold text-hover-primary fs-6">Popular Authors</a>
																...
																<tr>
																	...
																	<td>
																		<a href="#" class="mb-1 text-gray-900 fw-bold text-hover-primary fs-6">New Users</a>
																...
																<tr>
																	...
																	<td>
																		<a href="#" class="mb-1 text-gray-900 fw-bold text-hover-primary fs-6">Active Customers</a>
																		<span class="text-muted fw-semibold d-block">Movie Creator</span>
																	</td>
																...
																<tr>
																	...
																	<td>
																		<a href="#" class="mb-1 text-gray-900 fw-bold text-hover-primary fs-6">Bestseller Theme</a>
												...
												<div class="card-body">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center">
															...
															<!--end:Image-->
															<!--begin:Title-->
															<div class="pr-3 my-2 d-flex flex-column flex-grow-1 my-lg-0">
													...
													<!--end::Heading-->
													<!--begin:Stats-->
													<div class="mt-12 d-flex flex-column w-100">
														<span class="pb-3 text-gray-900 me-2 fw-bold">Progress</span>
													...
													<div class="mt-10 d-flex flex-column">
														<div class="pb-4 text-gray-900 me-2 fw-bold">Team</div>
														<div class="d-flex">
