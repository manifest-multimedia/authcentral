...
<div class="py-4 footer d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row flex-stack">
        ...
        <div class="order-2 text-gray-900 order-md-1">
            <span class="text-gray-500 fw-semibold me-1">Built with <i class="fas fa-heart text-danger"></i> by</span>
            <a href="https://manifestghana.com" target="_blank" class="text-muted text-hover-primary fw-semibold me-2 fs-6">Manifest Digital</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Menu-->
